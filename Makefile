...
test_denisenkom_go-mssqldb:
	-sqlcmd -I -S "$(REFORM_SQL_INSTANCE)" -Q "DROP DATABASE [reform-test];"
	sqlcmd -I -S "$(REFORM_SQL_INSTANCE)" -Q "CREATE DATABASE [reform-test];"
	sqlcmd -I -S "$(REFORM_SQL_INSTANCE)" -d "reform-test" -i internal/test/sql/mssql_init.sql
	sqlcmd -I -S "$(REFORM_SQL_INSTANCE)" -d "reform-test" -i internal/test/sql/mssql_data.sql
	sqlcmd -I -S "$(REFORM_SQL_INSTANCE)" -d "reform-test" -i internal/test/sql/mssql_set.sql
